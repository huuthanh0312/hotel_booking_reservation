...
<section class="checkout-area pt-100 pb-70">
    <div class="container">
        <form method="post" action="{{ route('checkout.store')}}" role="form" class="stripe_form require-validation"
                        ...
                        <div class="billing-details">
                            ...
                            <div style="display: flex">
                                <img style="height:100px; width:120px;object-fit: cover"
                                    src="{{ !empty($room->image) ? url($room->image) : 'upload/no_image.jpg' }}"
                            ...
                            <table class="table" style="width: 100%">
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: right ">
                                        <p class="text-danger">{{ $nights}} Day</p>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: right ">
                                        <p class="text-danger"><b> {{ $book_data['check_in']}} -
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: right">
                                        <p>{{$book_data['number_of_rooms']}} Room</p>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
