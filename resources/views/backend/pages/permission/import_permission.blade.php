...
<div class="page-content">
    ...
    <!--end breadcrumb-->
    <h6 class="mb-0 text-uppercase text-center">Import Permissions</h6>
    <hr />

    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <form action="{{route('import')}}" method="post" id="myForm" enctype="multipart/form-data">
                    @csrf
                    <div class="row mb-3">
                        <div class="col-sm-3">
                            <h6 class="mb-0">Xlsx File Import</h6>
                        </div>
