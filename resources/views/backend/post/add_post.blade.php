...
<div class="page-content">
    ...
    <!--end breadcrumb-->
    <h6 class="mb-0 text-uppercase text-center">Add Post</h6>
    <hr />

    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <form action="{{ route('blog.post.store')}}" method="post" id="myForm" enctype="multipart/form-data">
                    @csrf
                    <div class="row p-2">
                        ...
                        <div class="col-md-12 p-2">
                            ...
                            <textarea name="short_descp" id="" rows="4" class="form-control"></textarea>               
                        </div>
                        <div class="col-md-12 p-2">
                            <label for="post_title" class="form-label"> Description</label>
                            <textarea name="long_descp" id="content_tindy" class="form-control"></textarea>           
                        </div>
